export default {
  ...
  'pages.gpu.missing.title': 'GPU 资源面板需要 GPU 虚拟化插件',
  'pages.gpu.missing.subTitle':
    '正迁移到 Volcano vGPU（volcano-vgpu-device-plugin）。该插件作为 Volcano 调度器的 deviceshare 后端，提供 vGPU 切分 + 硬隔离能力；上线后这里会展示算力 / 显存 / 切分明细。',
  'pages.gpu.installing.title': 'GPU 虚拟化插件正在安装',
  'pages.gpu.installing.subTitle':
    '安装一般需要 1-2 分钟,本页会自动每 5 秒刷新;完成后会自动加载 GPU 数据。',
  'pages.gpu.failed.title': 'GPU 虚拟化插件安装失败',
  'pages.gpu.failed.subTitle':
    '请前往插件页查看错误详情并重新启用,或调整 values 后重试。',
  'pages.gpu.empty':
    '集群里没有检测到 GPU 节点。插件已就绪,但 GPU 节点可能还未上线或没有打到调度器视野里。',
  ...
  'pages.compute.cards.empty': '集群里没有 GPU 虚拟化插件上报的物理卡。',
