export default {
  ...
  'system.kind.server': 'Server',
  'system.kind.worker': 'Worker',
  'system.status.online': 'Online',
  'system.status.offline': 'Offline',
  'system.status.noDiag': 'No metrics',
  'system.status.noDiag.tooltip': 'Worker diag is not enabled — metrics unavailable',
  'system.col.node': 'Node',
  'system.col.status': 'Status',
  'system.col.uptime': 'Uptime',
  'system.col.goroutines': 'Goroutines',
  ...
  'pages.system.logs.toolbar.nodePlaceholder': 'Pick a node',
  'pages.system.logs.toolbar.level': 'Level',
  'pages.system.logs.toolbar.module': 'Module',
  'pages.system.logs.toolbar.modulePlaceholder': 'All modules',
  'pages.system.logs.toolbar.search': 'Search message…',
  'pages.system.logs.toolbar.liveTail': 'Live tail',
  'pages.system.logs.toolbar.refresh': 'Refresh',
  'pages.system.logs.toolbar.clear': 'Clear',
  'pages.system.logs.node.server': 'Control-plane Server',
  'pages.system.logs.node.workerPrefix': 'Worker · ',
  'pages.system.logs.node.offlineSuffix': ' (offline)',
  'pages.system.logs.level.all': 'All levels',
  'pages.system.logs.level.errorPlus': 'Error+',
  'pages.system.logs.level.warnPlus': 'Warn+',
  'pages.system.logs.level.infoPlus': 'Info+',
  'pages.system.logs.level.debugPlus': 'Debug+',
  'pages.system.logs.module.all': 'All modules',
  'pages.system.logs.module.empty': '(no module)',
  'pages.system.logs.empty.loading': 'Loading…',
  'pages.system.logs.empty.liveWaiting': 'Waiting for new logs…',
  'pages.system.logs.empty.noMatch': 'No logs match this filter',
  'pages.system.logs.tooltip.liveTail':
    'When on, polls every 2s and prepends new rows. Turn off to query a time range.',
  'pages.system.logs.status.count': '{count} rows',
  'pages.system.logs.status.countTrimmed': '{count} rows (oldest trimmed at cap)',
  'pages.system.logs.toolbar.limit': 'Limit',
  'pages.system.logs.toolbar.download': 'Download',
  'pages.system.logs.toolbar.reset': 'Reset',
  'pages.system.logs.download.txt': 'Download TXT',
  'pages.system.logs.download.ndjson': 'Download NDJSON',
  'pages.system.logs.results.title': 'Results',
  'pages.system.logs.fullscreen.enter': 'Enter fullscreen',
  'pages.system.logs.fullscreen.exit': 'Exit fullscreen (Esc)',
  ...
  'system.kpi.coresUnit': 'cores',
  'system.kpi.memory': 'Memory',
  'system.kpi.gcPause': 'GC pause p99',
  'system.kpi.schedLat': 'Sched latency p99',
  'system.kpi.fds': 'Open FDs',
  'system.tab.overview': 'Overview',
  'system.tab.memory': 'Memory',
  'system.tab.scheduler': 'Scheduler',
  'system.tab.network': 'Network',
  'system.tab.http': 'HTTP',
  'system.tab.db': 'Database',
  'system.tab.proxy': 'Cluster proxy',
  'system.tab.pprof': 'pprof',
  'system.chart.goroutines': 'Goroutines',
  'system.chart.heap': 'Heap (by segment)',
  'system.chart.gc': 'GC pause / rate',
  'system.chart.cpu': 'CPU utilization',
  ...
  'system.chart.gcFreq': 'GC frequency',
  'system.chart.yamuxTotals': 'Yamux sessions / total streams',
  'system.chart.httpTotals': 'HTTP cumulative requests / 5xx',
  'system.chart.dbClosed': 'DB connection evictions',
  'system.chart.tunnelState': 'Tunnel (streams / reconnects / uptime min)',
  'system.chart.routerHits': 'In-cluster router cache hits / misses',
  ...
  'system.chart.streams': 'Yamux streams (per cluster)',
  'system.chart.http': 'HTTP RPS / 5xx / p99',
  'system.chart.db': 'DB connection pool',
  'system.chart.proxyInflight': 'Proxy in-flight (per handler)',
  'system.chart.router': 'In-cluster router cache hit rate',
  'system.pprof.heap': 'Heap snapshot',
  'system.pprof.goroutine': 'Goroutine stack',
  'system.pprof.allocs': 'Allocations',
  'system.pprof.block': 'Blocking profile',
  'system.pprof.mutex': 'Mutex profile',
  'system.pprof.threadcreate': 'Thread creations',
  'system.pprof.profile': 'CPU profile (30 s)',
  'system.pprof.trace': 'Execution trace (5 s)',
  'system.pprof.confirmTitle': 'Confirm high-cost operation',
  'system.pprof.confirmBody':
    'This profile raises CPU on the target node by ~5% for 30 seconds. Only run this on production after confirming the investigation context.',
  'system.pprof.confirmOk': 'I understand — continue',
  'system.pprof.cancel': 'Cancel',
  'system.pprof.download': 'Download',
  'system.pprof.hint': 'After download, run `go tool pprof -http=:6060 <file>` locally to view the flame graph',
  'system.workerOnly': 'This panel is worker-only',
