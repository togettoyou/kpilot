export default {
  ...
  'pages.compute.overview.kpi.wait.avg': 'Avg wait',
  ...
  'pages.compute.overview.jobflows.title': 'JobFlow phase distribution',
  'pages.compute.overview.jobflows.subtitle': '{n} JobFlow(s)',
  'pages.compute.overview.jobflows.empty': 'No JobFlows in this namespace',
