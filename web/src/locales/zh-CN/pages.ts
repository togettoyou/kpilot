export default {
  ...
  'pages.compute.overview.kpi.wait.avg': '平均等待',
  ...
  'pages.compute.overview.jobflows.title': 'JobFlow 阶段分布',
  'pages.compute.overview.jobflows.subtitle': '共 {n} 个 JobFlow',
  'pages.compute.overview.jobflows.empty': '当前命名空间下没有 JobFlow',
