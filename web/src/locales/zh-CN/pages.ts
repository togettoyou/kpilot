export default {
  ...
  // —— v2 改版：tab 标签 + 分组小节 ——
  'pages.monitoring.tab.cluster': '集群',
  'pages.monitoring.tab.node': '节点',
  'pages.monitoring.tab.pod': 'Pod',
  'pages.monitoring.section.cluster.overview': '集群概览',
  'pages.monitoring.section.cluster.capacity': '资源趋势',
  'pages.monitoring.section.cluster.workload': '工作负载状态',
  'pages.monitoring.section.node.cpu': 'CPU',
  'pages.monitoring.section.node.mem': '内存',
  'pages.monitoring.section.node.disk': '磁盘',
  'pages.monitoring.section.node.network': '网络',
  'pages.monitoring.section.node.storage': '存储 I/O',
  'pages.monitoring.section.pod.cpu': 'Pod CPU Top-N',
  'pages.monitoring.section.pod.mem': 'Pod 内存 Top-N',
  'pages.monitoring.section.pod.network': 'Pod 网络 Top-N',
  'pages.monitoring.section.pod.io': 'Pod 磁盘 I/O Top-N',
  'pages.monitoring.section.pod.throttle': 'Pod CPU 节流 Top-N',
  'pages.monitoring.section.pod.memLimit': 'Pod 接近内存上限 Top-N',
  'pages.monitoring.section.pod.health': 'Pod 健康（重启 / OOM）',
  'pages.monitoring.lazy.scrollToLoad': '展开查看',
  'pages.monitoring.metric.load1': 'CPU 1 分钟平均负载',
  'pages.monitoring.metric.load5': 'CPU 5 分钟平均负载',
  'pages.monitoring.metric.load15': 'CPU 15 分钟平均负载',
  'pages.monitoring.metric.memUsedBytes': '内存使用量',
  'pages.monitoring.metric.diskPartitions': '分区使用率',
  'pages.monitoring.metric.tcpConns': 'TCP 连接数',
  'pages.monitoring.metric.diskIoWait': '磁盘 I/O 等待时间',
  'pages.monitoring.metric.diskIoService': '磁盘 I/O 服务时间',
  'pages.monitoring.metric.diskIoBusy': '磁盘 I/O 繁忙比率',
  'pages.monitoring.metric.clusterDisk': '集群磁盘利用率',
  'pages.monitoring.metric.restartRate': '容器重启速率',
  'pages.monitoring.metric.crashLooping': 'CrashLoopBackOff 容器数',
  'pages.monitoring.direction.read': '读',
  'pages.monitoring.direction.write': '写',
  ...
  'pages.logging.reset.tooltip': '重置为初始状态',
  'pages.logging.live.tooltip': '实时尾随：每 2 秒拉取新日志',
  'pages.logging.live.on': '实时',
  'pages.logging.live.off': '实时',
  'pages.logging.row.filterByPod': '筛选此 Pod',
  'pages.logging.row.copyPodName': '复制 Pod 名',
  'pages.logging.picker.container': '容器',
  'pages.logging.picker.container.placeholder': '选择容器',
  'pages.logging.picker.container.pickPodFirst': '请先选择 Pod',
  // LogsQL 速查
  'pages.logging.help.title': 'LogsQL 速查',
  'pages.logging.help.tooltip': 'LogsQL 语法示例',
  'pages.logging.help.docsLink': '完整文档 →',
  'pages.logging.help.group.text': '全文 / 短语',
  'pages.logging.help.group.stream': '流标签筛选',
  'pages.logging.help.group.field': '结构化字段',
  'pages.logging.help.group.logic': '逻辑',
  'pages.logging.help.group.pipes': '管道操作',
  'pages.logging.help.ex.text.word': '匹配 message 中包含 error 的日志',
  'pages.logging.help.ex.text.phrase': '匹配 message 中包含该完整短语',
  'pages.logging.help.ex.text.prefix': '前缀匹配：err / error / errors / errant',
  'pages.logging.help.ex.text.substring': '子串匹配：含 timeout 的任意位置',
  'pages.logging.help.ex.stream.ns': '只看 default 命名空间的日志',
  'pages.logging.help.ex.stream.nsPod': '命名空间 + Pod 双重精准筛选',
  'pages.logging.help.ex.stream.regex': '正则匹配 Pod 名（=~）',
  'pages.logging.help.ex.field.eq': 'level 字段等于 error',
  'pages.logging.help.ex.field.neq': '排除 level = debug 的日志',
  'pages.logging.help.ex.field.in': 'status 是 500/502/503 之一',
  'pages.logging.help.ex.field.cmp': '数值比较：status >= 500',
  'pages.logging.help.ex.field.exists': 'trace_id 字段存在（非空）',
  'pages.logging.help.ex.logic.and': '同时满足两个条件（AND 也可省略）',
  'pages.logging.help.ex.logic.orNot': 'OR 取并集，NOT 取反，括号控制优先级',
  'pages.logging.help.ex.pipes.stats': '聚合计数：当前查询命中数',
  'pages.logging.help.ex.pipes.sort': '按时间倒序取最近 100 条',
  'pages.logging.help.ex.pipes.fields': '只返回指定字段',
  ...
  'pages.gpuMonitoring.attention.oomRisk': '显存接近上限 (≥ 95%)',
  ...
  'pages.rollout.rollback': '回滚到此版本',
  'pages.rollout.col.revision': '版本',
  'pages.rollout.col.image': '镜像',
  'pages.rollout.col.replicas': '副本（就绪/期望）',
  'pages.rollout.col.age': '创建时间',
  'pages.rollout.col.changeCause': '变更说明',
  'pages.rollout.undo.confirm': '回滚到版本 #{revision}？将以该版本的 Pod 模板触发新一次滚动。',
  'pages.rollout.undo.success': '已回滚到版本 #{revision}',
  'pages.rollout.undo.noop': '已是该版本，无需回滚',
  // scale
  'pages.scale.title': '调整副本数',
  'pages.scale.confirm': '应用',
  'pages.scale.current': '当前副本数：{n}',
  'pages.scale.success': '副本数：{from} → {to}',
  ...
  'pages.podLogs.copy': '复制',
  'pages.podLogs.copied': '已复制 {n} 行',
  'pages.podLogs.copyFailed': '复制失败',
  ...
  'system.status.noDiag': '无指标',
  'system.status.noDiag.tooltip': 'Worker 端 diag 未启用，无法采集指标',
  'system.col.node': '节点',
  'system.col.status': '状态',
  'system.col.uptime': '上线时长',
  ...
  'pages.system.logs.toolbar.nodePlaceholder': '选择节点',
  'pages.system.logs.toolbar.level': '等级',
  'pages.system.logs.toolbar.module': '模块',
  'pages.system.logs.toolbar.modulePlaceholder': '全部模块',
  'pages.system.logs.toolbar.search': '搜索消息内容…',
  'pages.system.logs.toolbar.liveTail': '实时跟随',
  'pages.system.logs.toolbar.refresh': '刷新',
  'pages.system.logs.toolbar.clear': '清空',
  'pages.system.logs.node.server': '控制面 Server',
  'pages.system.logs.node.workerPrefix': 'Worker · ',
  'pages.system.logs.node.offlineSuffix': '（离线）',
  'pages.system.logs.level.all': '全部等级',
  'pages.system.logs.level.errorPlus': 'Error 及以上',
  'pages.system.logs.level.warnPlus': 'Warn 及以上',
  'pages.system.logs.level.infoPlus': 'Info 及以上',
  'pages.system.logs.level.debugPlus': 'Debug 及以上',
  'pages.system.logs.module.all': '全部模块',
  'pages.system.logs.module.empty': '（无模块名）',
  'pages.system.logs.empty.loading': '加载中…',
  'pages.system.logs.empty.liveWaiting': '正在等待新日志…',
  'pages.system.logs.empty.noMatch': '此范围内没有匹配的日志',
  'pages.system.logs.tooltip.liveTail':
    '开启后每 2 秒拉取新行，prepend 到列表顶部（关闭可手动指定时间范围查询）',
  'pages.system.logs.status.count': '{count} 条',
  'pages.system.logs.status.countTrimmed': '{count} 条（已达上限，旧行已被裁剪）',
  'pages.system.logs.toolbar.limit': '条数',
  'pages.system.logs.toolbar.download': '下载',
  'pages.system.logs.toolbar.reset': '重置',
  'pages.system.logs.download.txt': '下载 TXT',
  'pages.system.logs.download.ndjson': '下载 NDJSON',
  'pages.system.logs.results.title': '结果',
  'pages.system.logs.fullscreen.enter': '进入大屏模式',
  'pages.system.logs.fullscreen.exit': '退出大屏模式（按 Esc）',
  ...
  'system.kpi.coresUnit': '核',
  'system.kpi.memory': '内存使用率',
  'system.kpi.gcPause': 'GC 暂停 p99',
  'system.kpi.schedLat': '调度延迟 p99',
  'system.kpi.fds': '打开文件描述符',
  'system.tab.overview': '概览',
  'system.tab.memory': '内存',
  'system.tab.scheduler': '调度',
  'system.tab.network': '网络',
  'system.tab.http': 'HTTP',
  'system.tab.db': '数据库',
  'system.tab.proxy': '集群代理',
  'system.tab.pprof': 'pprof',
  'system.chart.goroutines': 'Goroutines',
  'system.chart.heap': 'Heap（按段）',
  'system.chart.gc': 'GC 暂停 / 频率',
  'system.chart.cpu': 'CPU 利用率',
  ...
  'system.chart.gcFreq': 'GC 频率',
  'system.chart.yamuxTotals': 'Yamux 总会话数 / 总流数',
  'system.chart.httpTotals': 'HTTP 累计请求 / 5xx',
  'system.chart.dbClosed': 'DB 连接淘汰统计',
  'system.chart.tunnelState': '隧道状态（流数 / 重连次数 / 上线时长分钟）',
  'system.chart.routerHits': '集群路由缓存命中 / 未命中',
  'system.chart.allocRate': 'Alloc 速率',
  'system.chart.schedLat': '调度延迟分位',
  'system.chart.mutexWait': 'Mutex 等待累计',
  'system.chart.streams': 'Yamux Stream（按集群）',
  'system.chart.http': 'HTTP RPS / 5xx / p99',
  'system.chart.db': 'DB 连接池',
  'system.chart.proxyInflight': '反代 in-flight（按 handler）',
  'system.chart.router': '集群路由缓存命中率',
  'system.pprof.heap': 'Heap 快照',
  'system.pprof.goroutine': 'Goroutine stack',
  'system.pprof.allocs': '分配快照',
  'system.pprof.block': '阻塞 profile',
  'system.pprof.mutex': 'Mutex profile',
  'system.pprof.threadcreate': '线程创建',
  'system.pprof.profile': 'CPU profile（30 秒）',
  'system.pprof.trace': '执行 trace（5 秒）',
  'system.pprof.confirmTitle': '高开销操作确认',
  'system.pprof.confirmBody':
    '该 profile 将让节点 CPU 使用率提升约 5%，持续 30 秒。生产环境只在确认排查的情况下运行。',
  'system.pprof.confirmOk': '我了解，继续',
  'system.pprof.cancel': '取消',
  'system.pprof.download': '下载',
  'system.pprof.hint': '下载后用 go tool pprof -http=:6060 <file> 在本机浏览器查看火焰图',
  'system.workerOnly': '此面板仅 Worker 节点可用',
